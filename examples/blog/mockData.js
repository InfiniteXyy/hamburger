import ydnjs from './raw/ydnjs';
import mddemo from './raw/mddemo';
...
export const posts = [
  {
    ...
    img:
      'https://images.unsplash.com/photo-1582100472526-b74c63e62d35?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&h=500&ixlib=rb-1.2.1&q=80&w=400',
    content: ydnjs
  },
  //https://source.unsplash.com/random/400x500
  {
    ...
    img:
      'https://images.unsplash.com/photo-1581073979866-823dad46086d?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&h=500&ixlib=rb-1.2.1&q=80&w=400',
    content: mddemo
  },
];
